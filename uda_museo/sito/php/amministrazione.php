		...
		echo "<div id='inserimentoTab'>";
			...
			if($_SESSION['Evento']==="crea"){
				...
				echo "</select><br><br>
					...
					titolo: <input type='text' name='titoloNuovo' placeholder='Inserisci il nome dell'evento'\> <br>
					tariffa: <input type='double' name='tariffa'  \><br>
					Numero biglietti:<input type='number' name='biglietti'  \><br>
					Categoria: <input type='text' name='categoria' placeholder='Inserisci la categoria'  \><br>
